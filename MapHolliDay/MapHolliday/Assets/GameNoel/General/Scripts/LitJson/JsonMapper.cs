...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static readonly IDictionary<Type, FactoryFunc> custom_factory_table;
        ...
        private static void RegisterBaseExporters()
        {
            ...
            base_exporters_table[typeof(float)] =
                delegate(object obj, JsonWriter writer) { writer.Write(Convert.ToDouble((float)obj)); };
        ...
        {
            FactoryFunc factoryWrapper = delegate { return factory(); };

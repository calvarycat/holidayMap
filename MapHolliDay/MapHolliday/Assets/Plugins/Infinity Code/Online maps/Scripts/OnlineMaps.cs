...
#region Methods
    ...
    public void Awake()
    {
       ...
       // AddMakerCenterEnglish();
        ...
        foreach (OnlineMapsMarker marker in markers)
        {
            //double lati;
            //double longti;
            //marker.GetPosition(out lati, out longti);
            //Debug.Log(lati + "  / '' " + longti + marker.label);
           marker.Init();
        }
      //  Debug.Log(d);
    ...
    void AddMakerCenterEnglish()
    {
       
        AddMarker(new Vector2(10.801491f, 106.664732f), "Hoang van thu");
        AddMarker(new Vector2(10.842847f, 106.656645f), "Go vap");
        AddMarker(new Vector2(10.742847f, 106.656645f), "Go va 1p");
    }
    ...
    public static string[] GetAvailableTypes(OnlineMapsProviderEnum provider)
    {
        ...
        if (provider == OnlineMapsProviderEnum.skobbler) return null;
        return types;
    }
